...
\question[4 (pg. 346-347)] A man enters Ben's Bagels to buy a dozen bagels only to learn that even though Ben has a large supply of plain bagels and blueberry bagels, he only has two cinnamon bagels left and no other kinds.
\begin{enumerate}[label=(\alph*)]
...
\end{enumerate}
\question[12 (pg. 348)] Suppose that we are interested in the number of non-negative integer solutions $a, b$ and $c$ of the equation $a + 2b + 3c = r$, where $r \in \N$.
\begin{enumerate}[label=(\alph*)]
    \item What is this number when $r \in \{1, 2, 3, 4\}$?
    \item Use generating functions to describe this number for a general $r \in \N$.
\end{enumerate}
\question[20 (pg. 350)] A man buys 6 doughnuts, each of which is a plain doughnut, a powdered doughnut or a glazed doughnut. How many possible selections are there if he buys at least one doughnut of each kind?
\begin{enumerate}[label=(\alph*)]
