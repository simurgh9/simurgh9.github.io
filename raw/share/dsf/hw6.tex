...
\begin{enumerate}
    ...
    \item Submit your \texttt{kmeans.py}. This is your $K$--Means implementation for the code in listing \ref{code}.
    \item Submit your \texttt{mnsit.py}. This is your $K$--Means implementation for the MNSIT test set in reference to the listing \ref{mnsit}.
\end{enumerate}
